...
<option value="Oppo" <?php if($brand=="Oppo") echo "selected"; ?>>Oppo</option>

<option value="Vivo" <?php if($brand=="Vivo") echo "selected"; ?>>Vivo</option>

<option value="Realme" <?php if($brand=="Realme") echo "selected"; ?>>Realme</option>

<option value="Redmi" <?php if($brand=="Redmi") echo "selected"; ?>>Redmi</option>
...
<p><strong>RAM:</strong> <?php echo htmlspecialchars($item["ram"]); ?></p>

<p><strong>Storage:</strong> <?php echo htmlspecialchars($item["storage"]); ?></p>

<p><strong>Processor:</strong> <?php echo htmlspecialchars($item["processor"]); ?></p>

<p><strong>Camera:</strong> <?php echo htmlspecialchars($item["camera"]); ?></p>

<p><strong>Battery:</strong> <?php echo htmlspecialchars($item["battery"]); ?></p>

<p><strong>Display:</strong> <?php echo htmlspecialchars($item["display"]); ?></p>

<p><strong>Rating:</strong> ⭐ <?php echo htmlspecialchars($item["rating"]); ?></p>

<p><strong>Stock:</strong> <?php echo htmlspecialchars($item["stock"]); ?></p>

<p><strong>Discount:</strong> <?php echo htmlspecialchars($item["discount"]); ?></p>
